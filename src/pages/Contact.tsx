        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Have questions about our smart card solutions? We're here to help. Reach out to our team for personalized assistance.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-1">Sales: sales@smartcardtech.com</p>
                    <p className="text-gray-600">Support: support@smartcardtech.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-1">123 Tech Plaza, Suite 400</p>
                    <p className="text-gray-600">San Francisco, CA 94105, USA</p>
                  </div>
                </div>
        ...
        <div className="container-custom">
          <div className="w-full h-[400px] bg-gray-200 rounded-xl overflow-hidden">
            ...
            <div className="w-full h-full flex items-center justify-center bg-gray-300">
              <MapPin size={48} className="text-gray-600 opacity-50" />
              <span className="ml-4 text-gray-600 font-medium text-lg">Interactive Map Placeholder</span>
            </div>
          </div>
        </div>
      </section>
